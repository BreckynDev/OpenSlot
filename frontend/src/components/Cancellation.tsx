...
const Cancellation = ({ date, time, name, email, service, onConfirmCancel, onKeepAppointment }: CancellationProps) => {
  return (
        ...
        <div className="flex justify-center mb-6">
          <div className="w-14 h-14 rounded-full bg-[#c0392b] flex items-center justify-center">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path d="M6 6L18 18M6 18L18 6" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>
          </div>
        </div>

        {/* Heading */}
        <h1 className="text-2xl font-medium text-[#2D312E] mb-1.5">Cancel appointment?</h1>
