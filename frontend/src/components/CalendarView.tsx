      ...
      <div className="w-[420px] max-w-full bg-white border border-[#e4e6e0] rounded-2xl p-6 font-sans">
        ...
        <DayPicker
          ...
          classNames={{
            ...
            button_previous: "w-8 h-8 border border-[#e4e6e0] rounded-lg bg-[#F8F9F5] text-[#7a8070] hover:bg-[#eef0ea] flex items-center justify-center text-sm [&>svg]:stroke-[#7a8070]",
            button_next: "w-8 h-8 border border-[#e4e6e0] rounded-lg bg-[#F8F9F5] text-[#7a8070] hover:bg-[#eef0ea] flex items-center justify-center text-sm [&>svg]:stroke-[#7a8070]",
            ...
            day_button: "w-10 h-10 flex items-center justify-center text-sm font-medium text-[#2D312E] rounded-full hover:bg-[#d0d8d0] cursor-pointer",
            selected: "!bg-[#3D5A42] !text-white [&>button]:!text-white rounded-full",
            outside: "text-[#e4e6e0]",
        ...
        <button
          onClick={() => selected && selectedTime && onContinue(selected, selectedTime)}
